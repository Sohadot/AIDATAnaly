...
| 5. Lead with the gap | Name follows meaning, not the reverse |

**Out of scope:** interface changes, routes, code, ATI/TFO deep dives (Sprint 13E), diagnostic examples (13D), reference article (13C).

---

## Name Binding Rules

These rules apply to **all** Sprint 13B copy and every external publication until the category is established.
...
- Link to https://aidatanaly.com/ or `/aida-transition-analytics/` on every channel post.
...
## Canonical Opening Block

Use this block (or a tight variant) as the **opening** of LinkedIn, X thread post 1, and any launch repost:
...
**Character note:** LinkedIn allows long-form; keep paragraphs short. One thesis per post.
...
**AIDA Transition Analytics** is the discipline of measuring that movement: not replacing AIDA, but governing what classical funnel practice left implicit — the transitions between Attention, Interest, Desire, Action, and Loyalty.
...
Explore the reference system: https://aidatanaly.com/  
Category overview: https://aidatanaly.com/aida-transition-analytics/
...
**Format:** ≤ 8 posts. Post 1 = canonical opening. Final post = link.
...
Funnel dashboards count **states**: impressions, sessions, leads, orders.

They rarely measure **movement** between those states.

A funnel can look full while transitions fail quietly.
...
**AIDA Transition Analytics** = measuring movement between AIDA stages — Attention, Interest, Desire, Action, Loyalty.

Not funnel occupancy. Not a rebrand of AIDA. The grammar *between* stages.
...
Reference system (live):

https://aidatanaly.com/

Category:

https://aidatanaly.com/aida-transition-analytics/
...
## External Publication Sequence (Updated)
...
**Do not invert this order.** ATI/TFO depth before name binding makes the project read as technical jargon before the category exists.
...
*Repository artifact only. Not included in `dist/` or sitemap. Publish copy verbatim or with operator edits that preserve Name Binding Rules.*
